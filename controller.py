...
app = webapp2.WSGIApplication([
    ...
    ('/do/apply_parse_schema_to_import_file', action_handlers.DoApplyParseSchemaToImportFile),
    ('/do/mark_import_file_as_parsed', action_handlers.DoMarkImportFileAsParsed),
