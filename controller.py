...
app = webapp2.WSGIApplication([
                                ...
                                ('/api/get_imported_file_descriptions',
                                 api.GetImportedFileDescriptions),
                                ('/api/get_imported_file', api.GetImportedFile),

                                ('/api/do/add_parse_schema', api_do.DoAddParseSchema),
                                ('/api/do/apply_parse_schema_to_import_file',
                                 api_do.DoApplyParseSchemaToImportedFile),
                                ...
                                ('/do/edit_user_profile_settings',
                                 profile_handlers.DoEditUserProfileSettings),
                                ('/do/connect_to_profile', profile_handlers.DoConnectToProfile),

                                # Taskqueues
                                ('/task/update_currency_rates',
                                 taskqueue_handlers.UpdateCurrencyRates)],
